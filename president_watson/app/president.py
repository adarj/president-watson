...
class President:
	def __init__(self):
		"""self.twitter_consumer_key = 'SizBhElt9lBywHsnDRSb6YYDD' 
		self.twitter_consumer_secret = 'RVts1W1g0Wnd2VkMtNacmzZFQPGtdOomW2lQ4xlf5plvUwElWB' 
		self.twitter_access_token = '58364068-gfx1dDuTZGI5iOrZllQUqsK0n6FqphutRkjQIAUVe' 
		self.twitter_access_secret = 'DLY2qabj2Bu30k8yWiBNwhlXMUuFaOHpLIZjBK3wnq0kb' 
		self.pi_username = '31dcb1a7-28c5-4e9e-be27-03cdd65a3db8' 
		self.pi_password = 'bryNkJZ4XtwE'"""
	...
	def set_API_keys(self):
		apiFile = open("api.txt", encoding="utf-8")
	...
	def analyze(self, handle):
		...
		personality_insights = PersonalityInsights(username=self.pi_username, password=self.pi_password)
